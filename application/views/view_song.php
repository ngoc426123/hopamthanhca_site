    ...
    <div class="box padding detail">
      <div class="box-heading">
        ...
        <div class="song-share">
          <ul>
            <li>
              <a class="fac share-facebook" href="javascript:void(0)">
            ...
            <li>
              <a
                class="goo"
                href=""
                onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600,hl=vi');return false;"
              >
            ...
            <li>
              <a
                class="love <?php echo ($love>0) ? 'active' : '' ?>"
                href=""
                data-post-id="<?php echo $data_page["song"]["id"] ?>"
                data-love='<?php echo $love; ?>'
                data-url="<?php echo base_url("updatelovesong"); ?>"
              >
              ...
              <div class="row">
                <div class="col-12 col-lg-4">
                  <div class="song-info">
                    <ul>
                      ...
                      <li>
                        <span class="song-info__att">Người đăng :</span>
                        <span class="song-info__ats"><?php echo $data_page["song"]["author"]["displayname"] ?></span>
                      </li>
                      <li>
                        <span class="song-info__att">Ngày đăng :</span>
                        <span class="song-info__ats"><?php echo $data_page["song"]["date"] ?></span>
                      </li>
                      <li>
                        <span class="song-info__att">Lượt xem :</span>
                        <span class="song-info__ats"><?php echo $data_page["song"]["meta"]["luotxem"] ?></span>
                      </li>
                      <li>
                        <span class="song-info__att">Tone chính :</span>
                        <span class="song-info__ats"><?php echo $data_page["song"]["meta"]["hopamchinh"] ?></span>
                      </li>
                      <li>
                        <span class="song-info__att">Điệu bài hát :</span>
                        <a
                          href="<?php echo $data_page["song"]["cat"]["dieu-bai-hat"][0]["permalink"] ?>"
                          class="song-info__ats"
                          title="<?php echo $data_page["song"]["cat"]["dieu-bai-hat"][0]["cat_name"] ?>"
                        >
                            <?php echo $data_page["song"]["cat"]["dieu-bai-hat"][0]["cat_name"] ?>
                        </a>
                      </li>
                      <?php
                        $chuyenmuc = $data_page["song"]["cat"]["chuyen-muc"][0]["cat_name"] ?? "Chưa rõ chuyên mục";
                      ?>
                      <li>
                        <span class="song-info__att">Chuyên mục :</span>
                        <a
                          href="<?php echo $data_page["song"]["cat"]["chuyen-muc"][0]["permalink"] ?>"
                          class="song-info__ats song-info--up"
                          title="<?php echo $chuyenmuc ?>"
                        >
                          <?php echo $chuyenmuc ?>
                        </a>
                        </li>
                ...
                <div class="col-12 col-lg-4">
                  <div class="song-intro d-none d-lg-block">
                    <ul>
                      <li>
                        <span class="song-intro__att">
                          <img src="<?php echo base_url("tmp/images/print.png"); ?>" alt="">
                        </span>
                        <span class="song-intro__ats song-intro--up">In bài hát</span></l
                        i>
                      <li>
                        <span class="song-intro__att">
                          <img src="<?php echo base_url("tmp/images/right.png"); ?>" alt="">
                        </span>
                        <span class="song-intro__ats song-intro--up">Thăng 1/2 note</span>
                      </li>
                      <li>
                        <span class="song-intro__att">
                          <img src="<?php echo base_url("tmp/images/left.png"); ?>" alt="">
                        </span>
                        <span class="song-intro__ats song-intro--up">Giáng 1/2 note</span>
                      </li>
                      <li>
                        <span class="song-intro__att">
                          <img src="<?php echo base_url("tmp/images/up.png"); ?>" alt="">
                        </span>
                        <span class="song-intro__ats song-intro--up">Tăng 1 font size</span>
                      </li>
                      <li>
                        <span class="song-intro__att">
                          <img src="<?php echo base_url("tmp/images/down.png"); ?>" alt="">
                        </span>
                        <span class="song-intro__ats song-intro--up">giảm 1 font size</span>
                      </li>
                    </ul>
                  </div>
                </div>
                <div class="col-12 col-lg-4">
                  <div class="song-pdf">
                    <div class="song-pdf__file">
                      <a href="<?php echo $pdf ?>" src="<?php echo $pdf ?>" downloaded target="_blank">
                      <img src="<?php echo base_url("tmp/images/pdf.svg"); ?>" alt="">
                      </a>
                    </div>
                    <div class="song-pdf__note">
                      (Click vào hình để xem hoặc tải file sheet nhạc)
                    </div>
                    <div class="song-pdf__note">
                      Xin cảm ơn tác giả, cũng là chủ của trang web <a href="http://www.thuvienamnhac.org/" terget="_blank">Thư viện âm nhạc</a>, tác giả <span>Đinh Công Huỳnh</span> đã cho phép trang web sử dụng file PDF từ trang.
                    </div>
                  </div>
                </div>
              </div>
